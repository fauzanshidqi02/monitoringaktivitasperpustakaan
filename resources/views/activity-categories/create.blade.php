...
<head>
    <meta charset="UTF-8">
    <title>Tambah Jenis Aktivitas</title>
    ...
    <div class="card">
        ...
        <form action="{{ route('activity-categories.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" value="{{ old('name') }}" placeholder="Contoh: Katalogisasi">
                @error('name')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                <label>Slug</label>
                <input type="text" name="slug" value="{{ old('slug') }}" placeholder="Contoh: katalogisasi">
            ...
            <div class="form-group">
                ...
                <textarea name="description" placeholder="Deskripsi jenis aktivitas...">{{ old('description') }}</textarea>
                @error('description')
                    <div class="error">{{ $message }}</div>
                @enderror
            </div>
